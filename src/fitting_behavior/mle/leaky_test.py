...
if test_op:
    ...
    for ii, cc in enumerate(comp_algs):
        ...
        if cc=='nac':
            ...
            rec_all_nac = []
            for jj, ka in enumerate(k_alph):
                # Simulate leaky nor model (off-policy) + extract novelty signals
                params_nac['k_alph'] = ka
                print(f'Leakiness of counts: {params_nac["k_alph"]}.')
            ...
            for jj, ka in enumerate(k_alph):
                # Simulate leaky nor model (off-policy) + extract novelty signals
                params_hyb['k_alph'] = ka
                print(f'Leakiness of counts: {params_hyb["k_alph"]}.')
...
if test_sim_ll:
    ...
    for ii, cc in enumerate(comp_algs):
        ...
        save_path = f'{base_path}data/test_leaky_{cc}'
        ...
        for ka in k_alph:
            ...
            params['k_alph'] = ka
            print(f'Leakiness of counts: {params["k_alph"]}.')
            sim_name = f'leaky-{params["k_alph"]}'.replace('.','_')
