...
python -u -b ${base_path}/src/fitting_behavior/recovery/sim_p_range.py -c ${base_path}/src/fitting_behavior/recovery/param_recov_range_configs/multisim-hnor_app_uniparam_seed-12345_l4.json | tee ${base_path}/logs/recovery/simdata_uniparam/${log_folder}/log_4.txt
