...
log_folder="$(date +'%Y-%m-%d_%H-%M-%S')_job-148"
...
echo "build job-148"
python -u -b ${base_path}/src/fitting_neural/grid_search_snov.py -c ${base_path}/src/fitting_neural/configs_gridsearch/snov-complex-leaky_set1_sep/job-148.json | tee ${base_path}/logs/grid_search_results/snov-complex-leaky_set1_sep/${log_folder}/log.txt
