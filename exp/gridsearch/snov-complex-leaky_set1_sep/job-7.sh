...
echo "build job-7"
python -u -b ${base_path}/src/fitting_neural/grid_search_snov.py -c ${base_path}/src/fitting_neural/configs_gridsearch/snov-complex-leaky_set1_sep/job-7.json | tee ${base_path}/logs/grid_search_results/snov-complex-leaky_set1_sep/${log_folder}/log.txt
