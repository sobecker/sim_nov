    ...
    python -u -b ${base_path}/src/fitting_behavior/ppc/sim_ppc.py -c ${base_path}/src/fitting_behavior/ppc/configs_ppc/multisim-leaky_hnor_notrace_5_app_uniparam_l1.json | tee ${base_path}/logs/ppc/sim__uniparam/${log_folder}/log_l1.txt
