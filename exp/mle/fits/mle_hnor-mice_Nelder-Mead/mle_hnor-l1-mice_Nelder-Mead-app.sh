...
echo "build mle_hnor-l1-mice_Nelder-Mead-app"
python -u -b ${base_path}/src/fitting_behavior/mle/mle_fit.py -c ${base_path}/src/fitting_behavior/mle/mle_fit_configs/mle_hnor-l1-mice_Nelder-Mead-app.json | tee ${base_path}/logs/mle/fits/${log_folder}/log_l1.txt
