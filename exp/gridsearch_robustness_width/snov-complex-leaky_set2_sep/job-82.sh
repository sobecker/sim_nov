...
log_folder="$(date +'%Y-%m-%d_%H-%M-%S')_job-82"
...
echo "build job-82"
python -u -b ${base_path}/src/fitting_neural/grid_search_snov.py -c ${base_path}/src/fitting_neural/configs_robustness/gridsearch_robustness_width/snov-complex-leaky_set2_sep/job-82.json | tee ${base_path}/logs/gridsearch_robustness_width/snov-complex-leaky_set2_sep/${log_folder}/log.txt
